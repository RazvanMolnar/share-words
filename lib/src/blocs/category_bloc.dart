...
class CategoryBloc extends Bloc<CategoryEvent, CategoryState> {
  ...
  Stream<CategoryState> _mapUpdateCategoryWordToState(
  ...
  Stream<CategoryState> _mapAddCategoryWordToState(
      AddCategoryWord event) async* {
    yield CategoryWordLoading();
  ...
  Stream<CategoryState> _mapDeleteCategoryWordToState(
